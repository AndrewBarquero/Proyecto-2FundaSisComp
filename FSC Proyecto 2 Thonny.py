...
en_mantenimiento = False #variable para entrar en modo mantenimiento.
...
def interaccion_producto_maquina(num):
    global cantidad_de_x_producto, cantidad_de_y_producto, cantidad_de_z_producto, conn, en_mantenimiento
    
    if en_mantenimiento:
        print("🚫 Bloqueado por mantenimiento")
        return
...
def funcion():
    while True:
        ...
        time.sleep_ms(100)
        if boton_servo.value() == 1 and not en_mantenimiento:
